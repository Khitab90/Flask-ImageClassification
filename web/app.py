...
class Register(Resource):
    def post(self):
        ...
        retJson = {
            "status": 200,
            "msg": "You have successfuly signed up for this API"
        }
        return jsonify(retJson)
...
#call classify_image as subprocess give it the image file and give other stuff
#this file is going to predict what this image is and it is going to write a file
#in a dictioniary
#read the file with predictions and load it into dictioniary
